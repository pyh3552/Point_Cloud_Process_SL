...
//    reader.read("/home/pyh/文档/GitHub/Point_Cloud_Process_SL/02-Nearest-Neighbor-Problem/doc/.pcd", *output);
    ...
    // -----------------------------------构建K-means-------------------------------------
    K_means k_means(4);
    Eigen::MatrixXd min_distance_index = k_means.fit(mx_in);
    //====================================着色=========================================
    ...
    // -----------------------------------保存点云---------------------------------------------
    pcl::io::savePCDFileASCII("/home/pyh/文档/GitHub/Point_Cloud_Process_SL/03-Clustering/doc/narrow_scene-4-means.pcd", *cloud);
